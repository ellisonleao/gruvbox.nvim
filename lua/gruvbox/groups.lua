...
M.setup = function()
  ...
  local groups = {
    ...
    DiffDelete = config.diff_syntax and { bg = colors.subtle_red }
      or { fg = colors.red, bg = colors.bg0, reverse = config.inverse },
    DiffAdd = config.diff_syntax and { bg = colors.subtle_green }
      or { fg = colors.green, bg = colors.bg0, reverse = config.inverse },
    DiffChange = config.diff_syntax and { bg = colors.subtle_brown }
      or { fg = colors.aqua, bg = colors.bg0, reverse = config.inverse },
    DiffText = config.diff_syntax and { bg = colors.subtle_yellow }
      or { fg = colors.yellow, bg = colors.bg0, reverse = config.inverse },
