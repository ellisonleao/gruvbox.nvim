...
groups.setup = function()
  ...
  local groups = {
    ...
    NavicIconsModule        =   {link = "GruvboxYellow"},
    NavicIconsNamespace     =   {link = "GruvboxYellow"},
    NavicIconsPackage       =   {link = "GruvboxBlue" },
    NavicIconsClass         =   {link = "GruvboxYellow"},
    NavicIconsMethod        =   {link = "GruvboxBlue"},
    NavicIconsProperty      =   {link = "GruvboxBlue"},
    NavicIconsField         =   {link = "GruvboxBlue"},
    NavicIconsConstructor   =   {link = "GruvboxYellow"},
    NavicIconsEnum          =   {link = "GruvboxOrange"},
    NavicIconsInterface     =   {link = "GruvboxYellow"},
    NavicIconsFunction      =   {link = "GruvboxBlue"},
    NavicIconsVariable      =   {link = "GruvboxOrange"},
    NavicIconsConstant      =   {link = "GruvboxOrange"},
    NavicIconsString        =   {link = "GruvboxOrange"},
    ...
    NavicIconsKey           =   {link = "GruvboxPurple"},
    NavicIconsNull          =   {link = "GruvboxFg1"},
    NavicIconsEnumMember    =   {link = "GruvboxOrange"},
    NavicIconsStruct        =   {link = "GruvboxYellow"},
    NavicIconsEvent         =   {link = "GruvboxOrange"},
    NavicIconsOperator      =   {link = "GruvboxOrange"},
    NavicIconsTypeParameter =   {link = "GruvboxYellow"},
  }
