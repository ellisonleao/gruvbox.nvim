...
local plugins = lush(function()
  return {
    ...
    LspDiagnosticsVirtualTextError {base.GruvboxGray},
    LspDiagnosticsVirtualTextWarning {base.GruvboxGray},
    LspDiagnosticsVirtualTextInformation {base.GruvboxGray},
    LspDiagnosticsVirtualTextHint {base.GruvboxGray},
