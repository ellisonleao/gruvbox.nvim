...
local function get_groups()
  ...
  local groups = {
    ...
    DiffDelete = config.invert_diff and { fg = colors.red, bg = colors.bg0 } or { bg = colors.dark_red },
    DiffAdd = config.invert_diff and { fg = colors.green, bg = colors.bg0 } or { bg = colors.dark_green },
    DiffChange = config.invert_diff and { fg = colors.aqua, bg = colors.bg0 } or { bg = colors.dark_aqua },
