...
local function get_groups()
  ...
  local groups = {
    ...
    NormalText = { link = "GruvboxFg1"},
    NormalTextGrayed = { link = "GruvboxFg2"},
    ...
    Function = { link = "NormalText" },
    PreProc = { link = "GruvboxAqua" },
    Include = { link = "GruvboxAqua" },
    Define = { link = "GruvboxAqua" },
    Macro = { link = "NormalText" },
    PreCondit = { link = "NormalText" },
    Constant = { link = "NormalText" },
    Character = { link = "String" },
    String = { fg = colors.green, italic = config.italic.strings },
    Boolean = { link = "NormalText" },
    Number = { link = "NormalText" },
    Float = { link = "NormalText" },
    Type = { link = "NormalText" },
    ...
    DiagnosticInfo = { link = "GruvboGruvboxGreenBoldxBlue" },
    ...
    cOperator = { link = "NormalText" },
    cppOperator = { link = "NormalText" },
    cStructure = { link = "GruvboxOrange" },
    pythonBuiltin = { link = "GruvboxOrange" },
    pythonBuiltinObj = { link = "NormalText" },
    pythonBuiltinFunc = { link = "NormalText" },
    pythonFunction = { link = "NormalText" },
    pythonDecorator = { link = "NormalText" },
    pythonInclude = { link = "Include" },
    pythonImport = { link = "Include" },
    pythonRun = { link = "GruvboxBlue" },
    pythonCoding = { link = "GruvboxBlue" },
    pythonOperator = { link = "NormalText" },
    pythonException = { link = "NormalText" },
    pythonExceptions = { link = "NormalText" },
    pythonBoolean = { link = "NormalText" },
    pythonDot = { link = "NormalText" },
    pythonConditional = { link = "GruvboxRed" },
    pythonRepeat = { link = "GruvboxRed" },
    pythonDottedName = { link = "NormalText" },
    ...
    luaFunction = { link = "GruvboxOrange" },
    ...
    ["@punctuation.delimiter"] = { link = "NormalText" },
    ["@punctuation.bracket"] = { link = "NormalText" },
