...
local function get_groups()
  ...
  local groups = {
    ...
    NeoTreeTitleBar = { bg = colors.dark4, fg = colors.dark0 },
    NeoTreeBufferNumber = { fg = colors.orange },
    NeoTreeMessage = { fg = colors.gray, italic = true },
    NeoTreeCursorLine = { link = "CursorLine", bold = true },
    ...
    NeoTreeWindowsHidden = { fg = colors.gray },
    ...
    NeoTreeGitUnstaged = { fg = colors.orange, italic = true, bold = true },
